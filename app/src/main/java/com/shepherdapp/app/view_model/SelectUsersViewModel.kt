...
class SelectUsersViewModel @Inject constructor(
    ...
    private val _selectedUserPositionLiveData = MutableLiveData<SingleEvent<Int>>()
    val selectedUserPositionLiveData: LiveData<SingleEvent<Int>> get() = _selectedUserPositionLiveData
    ...
    fun selectedPosition(position: Int) {
        _selectedUserPositionLiveData.value = SingleEvent(position)
    }
